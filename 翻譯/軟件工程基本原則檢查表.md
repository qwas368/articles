...
### 設計審查
- [ ] 進行設計審查的過程規範在[工作協議](https://microsoft.github.io/code-with-engineering-playbook/agile-development/team-agreements/working-agreements/)中。
- [ ] 對解決方案中的每個主要組件進行設計審查並記錄文檔，包括替代方案。
- [ ] _Strories_ 和 _Merge Request_ 要連結到設計文件。
- [ ] 預設情況，每個 User Story 會包含一個用於設計審查的工作，該工作在 _sprint planning_ 時期會被排入或移除。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzU2NTExMTMsLTEzNDMwNzIxNDksMT
