...
```
將型別傳遞到 `compose` 模板時，仍然存在很多雜音。只要你有一個兼容C ++ 14的編譯器，該編譯器支援帶有型別推論的廣義lambda函數（此代碼的功勞歸Eric Niebler所有），就可以避免：
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTM2NDM0NTUsMTk5NzMyMzI1NCw4MD
gxMjYwNjAsLTE0MDg0ODUzNDgsLTE0NTUwMzc4NTQsLTE5Mjkw
OTMwMiwyNTA4NDkyNTQsLTgxOTM5NDI5NF19
-->