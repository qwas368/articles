...
您可能已經猜到我並沒有當場發明這個類別。這是所謂的Kleisli範疇（Kleisli Category）的例子 — 一種基於monad的型別。我們尚未準備好討論monad，但我想讓你先了解它們的功能。出於有限的目的，Kleisli範疇有底層程式語言的型別作為物件。從型別A到型別B的態射是使用從A到用特定修飾派生的B型別的函數。每個Kleisli範疇都定義了自己組合態射的方式，以及關於該構圖的恆等態射。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MDQyNzc4LC0xMDYzODY3NjY4LC02Mz
Y5MTAxMTYsMzY4MzU2MjY4LDE5OTczMjMyNTQsODA4MTI2MDYw
LC0xNDA4NDg1MzQ4LC0xNDU1MDM3ODU0LC0xOTI5MDkzMDIsMj
UwODQ5MjU0LC04MTkzOTQyOTRdfQ==
-->