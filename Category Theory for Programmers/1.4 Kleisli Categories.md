...
Writer<A> identity(A);
```
它們在組合中必須表現的像是單位元一樣。如果你看一下我們的定義，您會發現身份同構應該傳遞其參數而無需更改，並且僅向日誌貢獻一個空字符串
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcyOTUzNjk2NCwxOTk3MzIzMjU0LDgwOD
EyNjA2MCwtMTQwODQ4NTM0OCwtMTQ1NTAzNzg1NCwtMTkyOTA5
MzAyLDI1MDg0OTI1NCwtODE5Mzk0Mjk0XX0=
-->