...
```
你可以輕鬆地說服自己，我們剛剛定義的範疇確實是合法範疇。特別地，我們的組合是結合律(associative)。如果你關注每對回傳中第一個元件的情況，那麼它只是一個常規的函數組合，符合結合律。第二個元件是被串聯的，並且串聯也是關聯的。
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzM3MDAxMTU2LDM2ODM1NjI2OCwxOTk3Mz
IzMjU0LDgwODEyNjA2MCwtMTQwODQ4NTM0OCwtMTQ1NTAzNzg1
NCwtMTkyOTA5MzAyLDI1MDg0OTI1NCwtODE5Mzk0Mjk0XX0=
-->