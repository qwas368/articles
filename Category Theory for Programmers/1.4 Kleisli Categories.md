...
我在本文中所用來作為範疇基礎的特定monad稱為`writer` monad，它用於log或追蹤函數的執行情況。這也是在純計算中嵌入影響的更通用機制的一個範例。ㄋㄧ之前已經看到過，我們可以在集合類別中建模編程語言類型和函數（通常不考慮底部）。
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjc4NDc2OTMsLTEwNjM4Njc2NjgsLTYzNj
kxMDExNiwzNjgzNTYyNjgsMTk5NzMyMzI1NCw4MDgxMjYwNjAs
LTE0MDg0ODUzNDgsLTE0NTUwMzc4NTQsLTE5MjkwOTMwMiwyNT
A4NDkyNTQsLTgxOTM5NDI5NF19
-->