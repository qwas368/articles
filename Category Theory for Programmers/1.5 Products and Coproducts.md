...
古希臘劇作家尤里比底斯曾經說過：「每個人都會變得跟他的好友一樣。」 我們是由我們的人際關係所定義的。這樣說法沒有比範疇論更正確的了。如果要在範疇中選一個特定的物件，則只能通過描述其與其他對象（及其本身）的關係模式來做到這一點。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM1ODcwMTk5LDIwOTk2NDUzNDBdfQ==
-->