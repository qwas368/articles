...
Haskell 的 classes 並不像 C++ 的 classes 一樣具有侵入性。當你定義一個新的 type，你無需預先指定其 class。你可以隨意拖延到在你聲明 type 為實例的時候才給定為某 class。舉一個例子，讓我們通過提供 `mempty` 和 `mappend` 的實現將String聲明為monoid (事實上，)。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxOTU5NzQ4OSwxMzYwMTMzNzU4LDM3OT
c5NjUzMiwtNjc5MjEwNzIzLDE1MDA0NTg1NCwxODEwOTg2Nzk5
LC02NDgxNzY3NTQsMzAyNDMwNTAwLDE5MTAwOTcxOTIsLTEzMj
U3NTAyODUsLTI2NTc1MTYyMywtMTU0NTg4ODM4OCwxNzI4ODIy
NjA3LDQxNjgzNjAzMiwtODI2MDYyMDg4LC04MTc1NDU5MzUsMT
kzNTc4MDk2NCw0MTMxMzExNTgsLTEzMDA0MjExMTUsLTM3OTQy
NzQ5M119
-->