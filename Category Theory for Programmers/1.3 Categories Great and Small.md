...
mappend s1 s2 = (++) s1 s2
```
前者在範疇 **Hask** (或 **SET**，如果我們忽略 bottoms ，又名為無盡計算(never-ending calculations)) 中能解釋為態射的相等。這樣的方程式不僅
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyNzQ5OTk0LC0yMDgyNTEwMDAxLDEzNj
AxMzM3NTgsMzc5Nzk2NTMyLC02NzkyMTA3MjMsMTUwMDQ1ODU0
LDE4MTA5ODY3OTksLTY0ODE3Njc1NCwzMDI0MzA1MDAsMTkxMD
