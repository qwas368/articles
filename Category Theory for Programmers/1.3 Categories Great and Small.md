...
您可能會問這個問題，是否每個範疇么半群 — 一個物件的範疇 — 定義一個唯一的二元運算子集合的么半群。事實證明我們總是可以單從單一物件範疇提取一個集合。這集合是態射集合 — 在我們例子中的加法器。換句話說，在範疇M中我們有單一物件m的hom-set   ![formula](https://render.githubusercontent.com/render/math?math=Hom(m,m)) 。我們可以輕鬆地在此集合中定義一個二元運算子：兩個集合元素的么半積 (monoidal product)，它是
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgzMDc1MjU5LDI4NDAxNzA2NSwxNDY4MD
k1OTUxLDE4NjI1NTkxMywyMDg5Mzc2NzQ0LC0xNjI1MDY1MjA0
LDk3Njg5MTE4NCwtOTU2NjA5MTIxLC01OTEzMTM5ODEsMzk4Nj
QwNDE3LC05NTY2MDkxMjEsLTU5MTMxMzk4MSw3ODI3OTcwMjUs
MTY1NTM0NjE1NSwtMTI1MzYyMjU0OCwxMzQ4NzE5MzUwLDIwMD
Q4OTAzOTgsNDM3NTI1MzgyLDEyMzgzMzcxNzEsMjAwODg2ODE2
OF19
-->