...
現在我想讓你忘記你正在處理的自然數集，而只是將其視為單個物件，一團的一堆態射—加法器。monoid是一個單個物件的範疇。事實上么半群的名稱來自於希臘 *mono*
 意思為單個。每個么半群都可以描述為具有一組態射
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk0NzUxMDQ3NywxOTI2MDA5NDEzLDU1MD
c5NTQsMTA5NDk4NjIwNSwxNDA1MTU3MzI0LDEwNTY3MDExNDgs
LTE0MzAxMzM2NjgsLTc3NTI3MzYzNSwtMTUwNzE1MTc3LDk1MT
