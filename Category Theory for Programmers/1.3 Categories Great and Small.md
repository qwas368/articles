...
就一個集合的元素而言么半群是一個「熟悉」的定義。但是，正如你所知，在範疇論中，我們試圖擺脫集合及其元素，而是談論物件和態射。因此，讓我們稍微改變觀點，將二元運算符的應用視為圍繞集合「移動”」或「位移」事物。
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxOTUxMjcxMCw5NTE1NjAyNzEsOTc0Mj
