...
一個精明的讀者可能已經註意到，從整數到加法器的映射遵循對 `mappend` 類型簽名的第二種解釋，即 `m ->（m -> m）`。它告訴我們 `mappend` 將一個么半群集合的元素映射到作用於該集合的函數。


<!--stackedit_data:
eyJoaXN0b3J5IjpbNTUwNzk1NCwxMDk0OTg2MjA1LDE0MDUxNT
czMjQsMTA1NjcwMTE0OCwtMTQzMDEzMzY2OCwtNzc1MjczNjM1
LC0xNTA3MTUxNzcsOTUxNTYwMjcxLDk3NDI4MzE5NywxNzc0Mz
g5NDksLTEzNjg1NDY0NCwtMjA4MjUxMDAwMSwxMzYwMTMzNzU4
LDM3OTc5NjUzMiwtNjc5MjEwNzIzLDE1MDA0NTg1NCwxODEwOT
g2Nzk5LC02NDgxNzY3NTQsMzAyNDMwNTAwLDE5MTAwOTcxOTJd
fQ==
-->