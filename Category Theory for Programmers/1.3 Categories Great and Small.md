...
## Simple Graphs
你可以僅透過箭頭(arrow)連結物件來建構範疇。你可以想像從任何一個[有向圖](https://en.wikipedia.org/wiki/Directed_graph)開始只要添加幾個透過來做成一個範疇
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTY2Njk2MzMsNDEzMTMxMTU4LC0xMz
